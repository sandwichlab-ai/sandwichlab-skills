...
**macOS / Linux:**
```bash
curl -fsSL https://raw.githubusercontent.com/sandwichlab-ai/sandwichlab-skills/main/scripts/install-ahcli.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/sandwichlab-ai/sandwichlab-skills/main/scripts/install-ahcli.ps1 | iex
```
